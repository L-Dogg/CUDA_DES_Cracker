...
Niestety nie udało się porownać wersji z obliczeniami na CPU, ponieważ już dla `KNOWN_ZEROS=37` obliczenia trwały ponad 3 minuty (dla Intel Core i5-4590 i powyższej pary wiadomość-klucz dokładnie 209.049000s).
